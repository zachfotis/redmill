...
function Services() {
  return (
    <section id="services" className="relative w-full h-full flex flex-col justify-start items-center gap-5 mx-auto my-10 lg:my-20 px-10">
      <Image src="/images/beans.png" alt="beans" width={ 300 } height={ 900 } className="absolute w-full h-full object-cover top-0 left-0 -z-10 opacity-5" />
      ...
      <div className="w-full max-w-[1600px] mt-5 lg:mt-14 grid grid-cols-[1fr] lg:grid-cols-[1fr_auto_1fr] gap-20">
        ...
        <div className="w-full relative hidden xl:block">
          <Image src="/images/coffee-bag.png" alt="bag of coffee" width={ 300 } height={ 900 }
            className="hover:scale-105 transition-all duration-300 ease-in-out" />
          <Image src="/images/coffee-cup.png" alt="cup of coffee" width={ 300 } height={ 900 }
