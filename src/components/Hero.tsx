...
function Hero() {
  return (
    <section id="home" className="relative w-full h-screen text-grayLight">
      <Parallax bgImage={ HeroImage.src } bgImageAlt="hero image" bgImageStyle={ { height: '100vh', objectFit: 'cover', scale: 1.1 } } strength={ 500 }
        className="w-full h-full" />
      <div className="absolute top-0 left-0 z-20 w-full h-full flex flex-col justify-center items-center gap-5">
        <Image src="/images/logo.png" alt="logo" className="spring-image w-[150px] lg:w-[300px]" width={ 300 } height={ 300 } />
        <h1 className="text-xl lg:text-2xl font-[400] font-serif italic tracking-wider ">Καλώς ήλθατε, στον</h1>
        ...
        <p className="text-xl lg:text-2xl font-serif tracking-wider font-[400]">Καφεκοπτείο - Καφέ</p>
      </div>
      {/* Black overlay */ }
