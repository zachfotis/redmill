...
export default function EU() {
  ...
  return (
    <section
      className={ `fixed w-full bottom-0 right-1/2 transform translate-x-1/2 ${ isMinimized ? 'translate-y-full' : 'translate-y-0' } z-50 bg-white flex justify-center items-center gap-10 p-3 transition-all duration-300 ease-in-out` }>
      <button
      ...
      <Image src="/images/eu1.png" alt="EU program logos" width={ 200 } height={ 200 } />
      <Image src="/images/eu2.png" alt="EU program logos" width={ 100 } height={ 100 } />
      <Image src="/images/eu3.png" alt="EU program logos" width={ 65 } height={ 100 } className="ml-7" />
      <Image src="/images/eu4.png" alt="EU program logos" width={ 75 } height={ 100 } className="ml-7" />
      <Image src="/images/eu5.png" alt="EU program logos" width={ 110 } height={ 100 } className="ml-5" />
