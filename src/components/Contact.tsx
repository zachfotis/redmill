          ...
          >
            <div className="flex flex-col lg:flex-row justify-between items-center gap-5">
              <div className="w-full flex flex-col justify-start items-start gap-2">
                <label htmlFor="name" className="text-base lg:text-lg font-serif tracking-wider font-[400]">
                  Ονοματεπώνυμο
                </label>
                <input
                  id="name"
              ...
              <div className="w-full flex flex-col justify-start items-start gap-2">
                <label htmlFor="email" className="text-base lg:text-lg font-serif tracking-wider font-[400]">
                  Email
                </label>
                <input
                  id="email"
            ...
            <div className="w-full flex flex-col justify-start items-start gap-2">
              <label htmlFor="message" className="text-base lg:text-lg font-serif tracking-wider font-[400]">
                Μήνυμα
              </label>
              <textarea
                id="message"
