        ...
        <section className="flex flex-col justify-start items-start gap-1 p-5">
          ...
          <div className="w-full grid grid-cols-[auto_1fr] gap-5 mt-5">
            ...
            <div className="flex flex-col justify-start items-end gap-3">
              <h1 className="text-lg font-[400] text-accent">07:00 π.μ. - 03:00 μ.μ.</h1>
              <h1 className="text-lg font-[400] text-accent">07:00 π.μ. - 03:00 μ.μ.</h1>
              <h1 className="text-lg font-[400] text-accent">07:00 π.μ. - 03:00 μ.μ.</h1>
              <h1 className="text-lg font-[400] text-accent">07:00 π.μ. - 03:00 μ.μ.</h1>
              <h1 className="text-lg font-[400] text-accent">07:00 π.μ. - 03:00 μ.μ.</h1>
              <h1 className="text-lg font-[400] text-accent">07:00 π.μ. - 03:00 μ.μ.</h1>
              <h1 className="text-lg font-[400] text-accent">08:00 π.μ. - 03:00 μ.μ.</h1>
            </div>
          </div>
        </section>
        <section className="flex flex-col justify-start items-start gap-1 p-5">
          ...
          <div className="w-full grid grid-cols-[auto_1fr] gap-10 mt-5">
            ...
            <div className="flex flex-col justify-start items-start gap-3">
              <h1 className="text-lg font-[400] text-accent">Νίκης 62, Νέα Πέραμος, Καβάλα</h1>
              <h1 className="text-lg font-[400] text-accent">+30 2594 023259</h1>
              <Link href="mailto:kokkinosmylos@yahoo.com" className="text-lg font-[400] text-accent">kokkinosmylos@yahoo.com</Link>
