...
function Procedure() {
  return (
    <section id="process" className="w-full max-w-[1600px] h-full flex flex-col justify-start items-center gap-5 mx-auto my-10 lg:my-20 px-5 lg:px-10">
      ...
      <h2 className="text-base lg:text-lg text-brownLight font-serif italic tracking-wider font-[500] -mt-3">όπως εσείς τον θέλετε!</h2>
      ...
      <div className="w-full mt-5 lg:mt-14 flex flex-col lg:flex-row justify-between items-stretch gap-10">
        <div className="flex-1 flex flex-col justify-start items-center gap-2 lg:gap-5">
          <Image src="/images/procedure1.jpeg" alt="Selection of coffee beans" width={ 300 } height={ 300 }
          ...
          <div className="w-full flex justify-start items-center gap-5">
            ...
            <h2 className="text-lg lg:text-xl text-center lg:text-left font-serif tracking-wider font-[700]">Επιλογή καφέ</h2>
          </div>
        ...
        <div className="flex-1 flex flex-col justify-start items-center gap-2 lg:gap-5">
          <Image src="/images/procedure2.jpg" alt="Coffee roasting process" width={ 300 } height={ 300 }
            className="h-[350px] w-full object-cover rounded-md shadow-md" />
          <div className="w-full flex justify-start items-center gap-5">
            <h1 className="text-3xl lg:text-5xl font-[600] font-serif italic text-brownLight">02</h1>
            <h2 className="text-lg lg:text-xl text-center lg:text-left font-serif tracking-wider font-[700]">Καβούρδισμα</h2>
          </div>
        ...
        <div className="flex-1 flex flex-col justify-start items-center gap-2 lg:gap-5">
          <Image src="/images/procedure3.webp" alt="Coffee grinding process" width={ 300 } height={ 300 }
            className="h-[350px] w-full object-cover rounded-md shadow-md" />
          <div className="w-full flex justify-start items-center gap-5">
            <h1 className="text-3xl lg:text-5xl font-[600] font-serif italic text-brownLight">03</h1>
            <h2 className="text-lg lg:text-xl text-center lg:text-left font-serif tracking-wider font-[700]">Άλεση (προαιρετικά)</h2>
          </div>
        ...
        <div className="flex-1 flex flex-col justify-start items-center gap-2 lg:gap-5">
          <Image src="/images/procedure4.jpg" alt="Enjoying a cup of coffee" width={ 300 } height={ 300 }
            className="h-[350px] w-full object-cover rounded-md shadow-md" />
          <div className="w-full flex justify-start items-center gap-5">
            <h1 className="text-3xl lg:text-5xl font-[600] font-serif italic text-brownLight">04</h1>
            <h2 className="text-lg lg:text-xl text-center lg:text-left font-serif tracking-wider font-[700]">Απολαύστε τον καφέ σας</h2>
          </div>
