...
function Menu() {
  ...
  const coffeeMenuItems = [
    ...
    { itemName: 'Espresso Κόκκινος Μύλος', itemPrice: '28,00' },
    { itemName: 'Ελληνικός Σκούρος', itemPrice: '20,00' },
    { itemName: 'Espresso Βραζιλίας (Brazilian)', itemPrice: '28,00' },
    { itemName: 'Ελληνικός Χωρίς Καφεΐνη', itemPrice: '24,00' },
    { itemName: 'Espresso Κολομβίας (Colombian)', itemPrice: '28,00' },
    ...
    { itemName: 'Espresso Αιθιοπίας (Ethiopian)', itemPrice: '29,00' },
    ...
    { itemName: 'Espresso Arabica', itemPrice: '30,00' },
    { itemName: 'Φίλτρου Μπισκότο', itemPrice: '30,00' },
    { itemName: 'Espresso Robusta', itemPrice: '23,00' },
    { itemName: 'Φίλτρου Καραμέλα', itemPrice: '30,00' },
    { itemName: 'Espresso 80% 20%', itemPrice: '27,00' },
